...
import { SearchInput, useSetParam } from '@/components/shared/list-controls'
...
export function FiltrosPuestos({
  ...
  const { searchParams: sp, setParams } = useSetParam()
  ...
  function updateProvincia(value: string) {
    setParams({ provincia: value || null, departamento: null })
  }
        ...
        <>
          ...
          <div className="border-t border-neutral-100 pt-4">
            <div className="flex justify-end">
              <button
                type="button"
                onClick={() => setParams(Object.fromEntries(CLAVES.map((k) => [k, null])))}
                className={[
