 ...
 * texto o el acento semántico que se les pase por className/color.
 *
 * Tamaños recomendados: 16px (inline), 20px (nav / botón), 24px (feature).
 */
...
export const SparklesIcon = (p: IconProps) => (
  <Icon {...p}>
    ...
    <path d="M5 18l.8 2L8 21l-2.2.9L5 24l-.8-2.1L2 21l2.2-1z" />
  </Icon>
);
...
// Logo de marca WhatsApp (relleno). No usa el <Icon> outline porque es un glyph
// de marca; hereda el color con fill="currentColor".
